  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background-light via-background-subtle to-white">
        ...
        <div className="max-w-7xl mx-auto px-6 py-6">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-800">Gestión de Propuesta Generada</h1>
                <p className="text-gray-600 text-sm">Como Administrador, puede gestionar completamente esta propuesta generada</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        {/* Acciones específicas para Administrador + Generada */}
        <div className="bg-white rounded-2xl shadow-soft p-8 mb-8 border border-gray-100">
          <div className="flex items-center space-x-4 mb-6">
            <div className="w-10 h-10 bg-gradient-to-br from-accent-purple to-accent-indigo rounded-xl flex items-center justify-center shadow-medium">
              <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div>
              <h3 className="text-xl font-bold text-gray-800">Acciones de Administrador - Propuesta Generada</h3>
              <p className="text-gray-600">Funciones específicas para gestionar propuestas generadas</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <button
              ...
              onClick={() => alert('Ejecutando: Revisar')}
            >
              <div className="flex items-center space-x-3">
                ...
                <span className="font-medium text-gray-800">Revisar</span>
              </div>
            </button>

            <button
              className="p-4 bg-gray-50 hover:bg-gray-100 rounded-lg border border-gray-200 transition-colors duration-200 text-left group"
              onClick={() => alert('Ejecutando: Aprobar')}
            >
              <div className="flex items-center space-x-3">
                ...
                <span className="font-medium text-gray-800">Aprobar</span>
              </div>
            </button>
          ...
          <div className="space-y-4">
            <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
              ...
              <p className="text-blue-700 text-sm">
                La propuesta se encuentra en el estado "Generada" y está siendo gestionada por el Administrador.
                Como administrador, tiene acceso completo para revisar, aprobar, rechazar o cambiar el estado de la propuesta.
              </p>
            </div>
            ...
            <div className="p-4 bg-green-50 rounded-lg border border-green-200">
              ...
              <p className="text-green-700 text-sm">
                ...
                Puede aprobar la propuesta para que avance al estado "Pre-conciliado" o rechazarla si no cumple con los requisitos.
              </p>
            </div>
          </div>
        </div>
...
export default AdministradorGenerada;
