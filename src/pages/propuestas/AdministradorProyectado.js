  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background-light via-background-subtle to-white">
        ...
        <div className="max-w-7xl mx-auto px-6 py-6">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-800">Gestión de Propuesta Proyectada</h1>
                <p className="text-gray-600 text-sm">Como Administrador, puede gestionar la propuesta proyectada</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        {/* Acciones específicas para Administrador + Proyectado */}
        <div className="bg-white rounded-2xl shadow-soft p-8 mb-8 border border-gray-100">
          <div className="flex items-center space-x-4 mb-6">
            <div className="w-10 h-10 bg-gradient-to-br from-primary-500 to-primary-600 rounded-xl flex items-center justify-center shadow-medium">
              <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div>
              <h3 className="text-xl font-bold text-gray-800">Acciones de Administrador - Propuesta Proyectada</h3>
              <p className="text-gray-600">Funciones específicas para gestionar propuestas proyectadas</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <button
              className="p-4 bg-gray-50 hover:bg-gray-100 rounded-lg border border-gray-200 transition-colors duration-200 text-left group"
              onClick={() => alert('Ejecutando: Finalizar')}
            >
              <div className="flex items-center space-x-3">
                ...
                <span className="font-medium text-gray-800">Finalizar</span>
              </div>
            </button>
          ...
          <div className="space-y-4">
            <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
              ...
              <p className="text-blue-700 text-sm">
                La propuesta se encuentra en el estado "Proyectado" y está siendo gestionada por el Administrador.
                Como administrador, puede revisar la proyección, finalizar el proceso, rechazarla o cambiar el estado.
              </p>
            </div>
            ...
            <div className="p-4 bg-green-50 rounded-lg border border-green-200">
              ...
              <p className="text-green-700 text-sm">
                Utilice las acciones disponibles arriba para finalizar el proceso de la propuesta. 
                Puede finalizar la propuesta o rechazarla si no cumple con los requisitos finales.
              </p>
            </div>
          </div>
        </div>
...
export default AdministradorProyectado;
