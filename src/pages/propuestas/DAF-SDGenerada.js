...
const DAFSDGenerada = () => {
  ...
  const handleCancelarChange = (id) => {
    setProgramas(prev =>
      prev.map(p =>
        p.id === id ? { ...p, cancelar: !p.cancelar } : p
      )
    );
  };
          ...
          return {
            ...
            personas: p.personas.map(persona =>
              persona.identificador === identificador
                ? {
                    ...persona,
                    monto_inicial: persona.monto, // Copiar el monto inicial
          ...
          return {
            ...
            personas: p.personas.map(persona =>
              persona.identificador === identificador
                ? {
                    ...persona,
                    monto_propuesto: persona.monto, // Revertir al monto original
    ...
    <div className="min-h-screen bg-gradient-to-br from-background-light via-background-subtle to-white">
        ...
        <div className="max-w-7xl mx-auto px-6 py-6">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-800">Gestión de Programas - DAF-SD</h1>
                <p className="text-gray-600 text-sm">Revise y marque programas con riesgo de inauguración</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="w-[99vw] box-border mx-auto px-6 py-8">
            ...
            <table className="w-full divide-y divide-gray-200" style={{ tableLayout: 'fixed', width: '100%' }}>
              ...
              <thead className="bg-gray-50">
                <tr className="align-middle">
                  ...
                  <th className="px-4 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">
                    <span className="block whitespace-normal leading-tight">No Aperturar<br/>(DAF-SD)</span>
                  </th>
                </tr>
              </thead>
                      ...
                      >
                        ...
                        <td className="px-4 py-3 whitespace-nowrap text-center">
                          <input
                            ...
                            onChange={(e) => {
                              e.stopPropagation();
                              handleCancelarChange(programa.id);
                            }}
                                      ...
                                      <tr key={m.identificador} className={
                                        ...
                                        <td className="px-2 py-1">
                                          <input
                                            ...
                                            onChange={(e) => handleMontoPropuestoChange(programa.id, m.identificador, e.target.value)}
                                        ...
                                        <td className="px-2 py-1">
                                          ...
                                          {m.monto_propuesto && m.monto_propuesto !== m.monto && (
                                            <button
                                              onClick={(e) => {
                                                e.stopPropagation();
                                                handleRevertirMonto(programa.id, m.identificador);
                                              }}
        ...
        <div className="flex justify-end">
          <button
            className="px-8 py-3 bg-accent-orange hover:bg-accent-red text-white font-bold rounded-lg shadow-soft transition-colors duration-200 text-lg"
