  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background-light via-background-subtle to-white">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">Como DAF, debe validar la conciliación realizada</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        {/* Acciones específicas para DAF + Conciliado */}
        <div className="bg-white rounded-2xl shadow-soft p-8 mb-8 border border-gray-100">
          <div className="flex items-center space-x-4 mb-6">
            <div className="w-10 h-10 bg-gradient-to-br from-accent-green to-accent-teal rounded-xl flex items-center justify-center shadow-medium">
              <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div>
              <h3 className="text-xl font-bold text-gray-800">Acciones de DAF - Propuesta Conciliada</h3>
          ...
          <div className="space-y-4">
            <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
              ...
              <p className="text-blue-700 text-sm">
                La propuesta se encuentra en el estado "Conciliado" y está siendo validada por el DAF.
                Como DAF, debe validar la conciliación realizada, aprobar la proyección o solicitar revisiones.
              </p>
            </div>
