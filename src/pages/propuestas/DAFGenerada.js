            ...
            personas: p.personas.map(persona =>
              persona.identificador === identificador
                ? {
                    ...
                    monto_propuesto_daf: nuevoMonto, // Guardar el monto propuesto por DAF
            ...
            personas: p.personas.map(persona =>
              persona.identificador === identificador
                ? {
                    ...
                    monto_propuesto_daf: persona.monto, // Revertir también el monto propuesto por DAF
        ...
        <div className="max-w-7xl mx-auto px-6 py-6">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-800">Gestión de Programas - DAF</h1>
