        ...
        <div className="max-w-7xl mx-auto px-6 py-6">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-800">Gestión de Proyecto</h1>
                <p className="text-gray-600 text-sm">Como JP, debe gestionar los aspectos del proyecto</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="bg-white rounded-2xl shadow-soft p-8 mb-8 border border-gray-100">
          <div className="flex items-center space-x-4 mb-6">
            <div className="w-12 h-12 bg-gradient-to-br from-accent-purple to-accent-indigo rounded-xl flex items-center justify-center shadow-medium">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-gray-900">JP</p>
            </div>
          </div>
        </div>

        {/* Acciones específicas para JP + Generada */}
        <div className="bg-white rounded-2xl shadow-soft p-8 mb-8 border border-gray-100">
          <div className="flex items-center space-x-4 mb-6">
            <div className="w-10 h-10 bg-gradient-to-br from-accent-purple to-accent-indigo rounded-xl flex items-center justify-center shadow-medium">
              <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div>
              <h3 className="text-xl font-bold text-gray-800">Acciones de JP - Propuesta Generada</h3>
              <p className="text-gray-600">Funciones específicas para gestión de proyecto</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <button
              ...
              onClick={() => alert('Ejecutando: Revisar Proyecto')}
            >
              <div className="flex items-center space-x-3">
                ...
                <span className="font-medium text-gray-800">Revisar Proyecto</span>
              </div>
            </button>

            <button
              className="p-4 bg-gray-50 hover:bg-gray-100 rounded-lg border border-gray-200 transition-colors duration-200 text-left group"
              onClick={() => alert('Ejecutando: Asignar Recursos')}
            >
              <div className="flex items-center space-x-3">
                ...
                <span className="font-medium text-gray-800">Asignar Recursos</span>
              </div>
            </button>

            <button
              className="p-4 bg-gray-50 hover:bg-gray-100 rounded-lg border border-gray-200 transition-colors duration-200 text-left group"
              onClick={() => alert('Ejecutando: Planificar Ejecución')}
            >
              <div className="flex items-center space-x-3">
                ...
                <span className="font-medium text-gray-800">Planificar Ejecución</span>
              </div>
            </button>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-soft p-8 border border-gray-100">
          ...
          <div className="space-y-4">
            <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
              <h4 className="font-semibold text-blue-800 mb-2">Estado Actual: Generada</h4>
              <p className="text-blue-700 text-sm">
                La propuesta se encuentra en el estado "Generada" y está siendo gestionada por el JP.
                Como JP, debe revisar el proyecto, asignar recursos y planificar la ejecución.
              </p>
            </div>
            ...
            <div className="p-4 bg-green-50 rounded-lg border border-green-200">
              ...
              <p className="text-green-700 text-sm">
                Utilice las acciones disponibles arriba para avanzar en el proceso de gestión del proyecto. 
                Puede revisar el proyecto, asignar recursos y planificar la ejecución para que avance al estado "Pre-conciliado".
              </p>
            </div>
          </div>
        </div>
